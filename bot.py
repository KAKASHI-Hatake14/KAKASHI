...
async def start(event):
    ...
    [Button.url("Mʏ Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", "https://github.com/KAKASHI-Hatake14/KAKASHI")]
    ])
...
"""
    await event.reply(text, buttons=[[Button.url("Mʏ Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", "https://github.com/KAKASHI-Hatake14/KAKASHI")]])
